...
public class User {
    ...
    public String name_servicio;


    public User() {
    }

    public User(String cod_servicio,String id, String correo, String parent_id, String nombre, String lat, String lng, String clave, int smart_control, Configuration configuration,String fcm,String gname_servicio) {
        this.id = id;
        this.correo = correo;
        ...
        this.name_servicio = name_servicio;
    }
    ...
    public String getName_servicio() {
        return name_servicio;
    }

    public void setName_servicio(String name_servicio) {
        this.name_servicio = name_servicio;
    }
}
